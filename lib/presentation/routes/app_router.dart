...
import '../screens/parsing_reminders_screen.dart';
  ...
  final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => const NewOrderDetailsScreen(),
      ),
      GoRoute(
        path: '/parsing-reminders',
        builder: (context, state) => const ParsingRemindersScreen(),
      ),
      GoRoute(
        path: '/orders',
