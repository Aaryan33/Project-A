      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildSectionHeader('TRIP EXPENSES FILTER'),
            Wrap(
              spacing: 8,
              runSpacing: 8,
              children: [
                _buildChip('All Trip Total Expense', _tempFilters.expenseCategory == 'ALL_EXPENSES', () {
                  setState(() => _tempFilters = _tempFilters.copyWith(
                        expenseCategory: _tempFilters.expenseCategory == 'ALL_EXPENSES' ? null : 'ALL_EXPENSES',
                      ));
                }),
                ...AppConstants.expenseCategories.map((cat) {
                  return _buildChip(cat, _tempFilters.expenseCategory == cat, () {
                    setState(() => _tempFilters = _tempFilters.copyWith(
                          expenseCategory: _tempFilters.expenseCategory == cat ? null : cat,
                        ));
                  });
                }),
              ],
